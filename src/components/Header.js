        ...
        <div className='bg-light'>
            <div className="container py-5">
                <Link className='nav-link' to={'/'}>
                    <h4 className='text-uppercase'>  <span className='bg-danger text-white '>longtail</span><span className='bg-dark text-danger'>MARKETS</span><span className='text-muted'></span> </h4>
                </Link>
