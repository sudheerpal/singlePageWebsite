            ...
            <div className="container py-5">
                <div className="row">
                    <div className="col-md-6 mt-3">
                        <img className='w-100 shadow border p-1' src="https://images.unsplash.com/photo-1511174511562-5f7f18b874f8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="" />
