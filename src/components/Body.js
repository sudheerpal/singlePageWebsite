            ...
            <div className="container py-5">
                <div className="row">
                    <div className="col-md-6 mt-3">
                        <img className='w-100 shadow border p-1' src="https://images.unsplash.com/photo-1552581234-26160f608093?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bWFya2V0JTIwc3R1ZHl8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="" />
